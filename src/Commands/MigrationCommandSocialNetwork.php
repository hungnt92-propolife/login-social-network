...
use Exception;
use HungNguyen\LoginSocialNetwork\migrations\AddColumnSaveUuidSocialNetworkTable;
...
class MigrationCommandSocialNetwork extends Command
{
     ...
     * @var string
     */
    protected $signature = 'runMigration:model {modelName} {status}';
     ...
     * @var string
     */
    protected $description = 'Add field social_id in model target, status is up/down';
